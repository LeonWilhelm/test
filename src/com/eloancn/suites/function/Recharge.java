...
//	}
	...
	public void rechargeTransferRemittance_AT_479(){
		Reporter.log("投资流程：充值 转账汇款，提示“恭喜您，身份认证已成功”<br/>");
		myAccountPage.turnToMyAccount("安全认证");
		myAccountPage.turnToMyAccount("充值");
		System.out.print("姓名："+realName2 +"\n"+"身份证号："+idCard2);
		rechargePage.rechargeTransferRemittance(realName2, idCard2, zzmm,"2015-05-01","99000000","中国银行","3333","自动化测试，请拒！谢谢");
		//判断是否充值成功
		rechargePage.isRecharge();
		times++;
		System.out.println("第"+times+"充值成功");
	}
